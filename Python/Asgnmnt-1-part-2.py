#PART 2: CALCULATE THE REMAINING BALANCE OF A LOAN  (35 points possible)
...
def calculate_remaining_loan_balance(principal,annual_interest_rate,duration,number_of_payments) :
       ...
       if r==0 :
              ...
              remaining_loan_balance=principal*(num_val/den_val)
              return remaining_loan_balance
